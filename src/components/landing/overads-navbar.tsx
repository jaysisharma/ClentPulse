      ...
      <div className="relative flex h-20 w-full items-center justify-between px-6 sm:px-10 lg:px-12">
        ...
        <div className="pointer-events-auto flex items-center z-10">
          <Link href="/" className="inline-flex items-center transition-opacity hover:opacity-85">
            <Logo className="w-6 h-6 text-slate-900 dark:text-white" />
            <span className="ml-2.5 font-bold text-base tracking-tight text-slate-950 dark:text-white font-mono">Frevio</span>
          </Link>
        </div>

        {/* Center: Navigation Links Pill */}
        <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-1 rounded-full bg-white/80 dark:bg-[#0e1017]/80 py-1.5 px-3.5 shadow-sm dark:shadow-[0_8px_32px_rgba(0,0,0,0.36)] border border-slate-200/80 dark:border-white/10 backdrop-blur-xl pointer-events-auto z-10 transition-colors duration-200">
            ...
            >
              ...
              {productMenuOpen && (
                <div className="absolute -left-6 top-full pt-2 z-50 w-[420px] animate-in fade-in slide-in-from-top-1 duration-150">
                  <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/95 dark:bg-[#0e1017]/98 backdrop-blur-2xl p-3 shadow-2xl ring-1 ring-black/5 dark:ring-white/5 grid grid-cols-2 gap-2 text-slate-800 dark:text-slate-200">
                    <Link
                      href="#presence"
        ...
        <div className="hidden md:flex items-center gap-2.5 pointer-events-auto z-10">
          ...
          {isLoggedIn ? (
            <Link
              href="/dashboard"
              className="inline-flex items-center justify-center gap-1.5 rounded-full bg-slate-950 dark:bg-white font-medium text-white dark:text-slate-950 hover:bg-slate-800 dark:hover:bg-white/90 h-9 px-4 text-sm transition-all hover:scale-[1.02] shadow-sm cursor-pointer"
            >
              <span>Dashboard</span>
            ...
            <>
              <Link
                href="/auth/login"
                className="inline-flex h-9 items-center rounded-full px-3 text-sm font-medium text-slate-600 hover:text-slate-950 dark:text-slate-300 dark:hover:text-white transition-colors"
              >
                Sign in
              </Link>
        ...
        {/* Mobile Header Bar */}
        <div className="flex w-full items-center justify-between md:hidden pointer-events-auto rounded-full border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-[#0e1017]/90 backdrop-blur-xl px-4 py-2 shadow-lg">
          <Link href="/" className="inline-flex items-center gap-2">
            <Logo className="w-5 h-5 text-slate-900 dark:text-white" />
            <span className="font-bold text-sm text-slate-950 dark:text-white font-mono">Frevio</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 rounded-full bg-slate-950 dark:bg-white px-3.5 py-1.5 text-xs font-semibold text-white dark:text-slate-950 hover:bg-slate-800 dark:hover:bg-white/90"
            >
