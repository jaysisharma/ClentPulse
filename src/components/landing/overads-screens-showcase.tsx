...
import { Radio, Globe, CreditCard, CheckCircle2, ShieldCheck, Clock, Check, ArrowRight, Zap, Play, Terminal, ExternalLink } from 'lucide-react'
...
export function OveradsScreensShowcase() {
  ...
  return (
    <section ref={sectionRef} id="screens" className="relative w-full py-20 md:py-28 bg-[#08090a] text-white">
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <p className="text-sm sm:text-base leading-relaxed text-slate-400 font-light max-w-2xl mx-auto">
            Where your time went, what your clients see, and how you get paid. No bloat, no spreadsheets.
          </p>
        </div>

        {/* Segmented Pill Switcher (overads style) */}
        <div ref={tabBarRef} className="flex justify-center mb-12">
          <div className="relative flex flex-wrap items-center justify-center rounded-full border border-white/15 bg-black/40 p-1 shadow-2xl backdrop-blur-xl">
            {TABS.map(tab => {
              const Icon = tab.icon
        ...
        <div ref={screenCardRef} className="relative rounded-3xl border border-white/10 bg-[#0e0f16] p-6 sm:p-10 shadow-2xl overflow-hidden">
          {/* Subtle glow accent based on tab */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full blur-[140px] opacity-20 -z-10"
            style={{
              backgroundColor:
          ...
          {activeTab === 'presence' && (
            <div className="grid gap-8 lg:grid-cols-12 items-center">
              <div className="lg:col-span-5 space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 text-xs text-emerald-400">
                  <Radio className="w-3 h-3 animate-pulse" /> Live Coding Activity
                </div>
                ...
                <p className="text-sm leading-relaxed text-slate-400">
                  Frevio detects keystrokes in VS Code or Antigravity and sends encrypted heartbeats. If you step away for 5 minutes, it automatically pauses so you never log accidental phantom time.
                </p>
              ...
              <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-[#07080c] p-5 shadow-2xl font-mono text-xs">
                {/* Simulated IDE Bar */}
                <div className="flex items-center justify-between pb-3 border-b border-white/10 text-slate-400">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-slate-500 ml-2">Frevio: Workspace Monitor</span>
                  </div>
                ...
                <div className="py-6 space-y-4">
                  <div className="flex flex-wrap items-center justify-between gap-2 p-3.5 rounded-xl bg-white/[0.03] border border-white/5 font-sans">
                    <div>
          ...
          {activeTab === 'status' && (
            <div className="grid gap-8 lg:grid-cols-12 items-center">
              <div className="lg:col-span-5 space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 text-xs text-indigo-400">
                  <Globe className="w-3 h-3" /> Client Experience
                </div>
                <h3 className="text-2xl sm:text-3xl font-light text-white tracking-tight">
                  Passcode-locked live client link. Zero logins.
                </h3>
                <p className="text-sm leading-relaxed text-slate-400">
                  Clients visit a sleek, bespoke URL like <code className="text-indigo-300">frevio.cloud/p/acme-app</code>. They enter a passcode to view milestones, read weekly bullet updates, and reply directly.
                </p>
                <ul className="space-y-2.5 text-xs sm:text-sm text-slate-300">
                  <li className="flex items-center gap-2.5">
              ...
              <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-slate-50 text-slate-900 p-6 shadow-2xl">
                {/* Status Page Mockup */}
                <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-400">Client: Sarah Jenkins</div>
                    </div>
                  </div>
                ...
                <div className="py-4 space-y-3">
                  ...
                  <div className="mt-4 rounded-xl bg-white border border-slate-200 p-4 space-y-2">
                ...
                <div className="pt-3 border-t border-slate-200 flex items-center justify-between text-xs text-slate-400">
                  ...
                  <span className="text-indigo-600 font-semibold">frevio.cloud/p/acme-app</span>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'invoice' && (
            <div className="grid gap-8 lg:grid-cols-12 items-center">
              <div className="lg:col-span-5 space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full bg-amber-500/10 border border-amber-500/20 px-3 py-1 text-xs text-amber-400">
                  <CreditCard className="w-3 h-3" /> Seamless Payments
                </div>
                <h3 className="text-2xl sm:text-3xl font-light text-white tracking-tight">
              ...
              <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-[#0b0c11] p-6 shadow-2xl text-white">
                <div className="flex items-center justify-between pb-4 border-b border-white/10">
                  <div>
                    <div className="text-xs uppercase tracking-widest text-slate-500 font-semibold">Invoice</div>
                    <div className="font-mono text-sm font-semibold text-white mt-0.5">#INV-2026-084</div>
                  </div>
                  <span className="bg-amber-400/10 text-amber-300 border border-amber-400/20 px-2.5 py-1 rounded-full text-xs font-semibold">
                    Due in 7 days
                  </span>
                </div>
                ...
                <div className="py-5 space-y-3">
                  <div className="flex justify-between items-center text-sm py-2 border-b border-white/5">
                    <span className="text-slate-300">Backend API & Database Architecture (18.5 hrs)</span>
                    <span className="font-mono text-white">$2,775.00</span>
                  </div>
                  <div className="flex justify-between items-center text-sm py-2 border-b border-white/5">
                    <span className="text-slate-300">Stripe Webhook & Checkout Flow (6.0 hrs)</span>
                    <span className="font-mono text-white">$900.00</span>
                  </div>

                  <div className="pt-2 flex justify-between items-baseline">
                    <span className="text-slate-400 text-sm">Total Due</span>
                    <span className="text-2xl sm:text-3xl font-bold text-white font-mono">$3,675.00</span>
                  </div>
                </div>

                <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
                  <div className="text-xs text-slate-400">Powered by Stripe Connect</div>
                  <button className="bg-white text-slate-900 px-5 py-2 rounded-xl text-xs font-bold hover:bg-slate-100 transition-colors shadow-sm cursor-pointer">
                    Pay Now with Stripe →
                  </button>
                </div>
              </div>
          ...
          {activeTab === 'approvals' && (
            <div className="grid gap-8 lg:grid-cols-12 items-center">
              <div className="lg:col-span-5 space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full bg-violet-500/10 border border-violet-500/20 px-3 py-1 text-xs text-violet-400">
                  <CheckCircle2 className="w-3 h-3" /> Scope Protection
                </div>
                <h3 className="text-2xl sm:text-3xl font-light text-white tracking-tight">
              ...
              <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-[#0c0d14] p-6 shadow-2xl space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-white/10">
                  <span className="text-xs font-semibold text-slate-400">Awaiting Client Approval</span>
                  <span className="text-[11px] text-violet-400 font-mono">Deliverable #3</span>
                </div>

                <div className="space-y-2">
                  <div className="text-base font-semibold text-white">Interactive Staging Environment v2.4</div>
                  <p className="text-xs text-slate-400">
                    Live prototype deployed with all checkout modifications and responsive tablet layouts.
                  </p>
                  <a href="#demo" className="inline-flex items-center gap-1 text-xs text-indigo-400 hover:underline pt-1">
                    staging.clientapp.dev <ExternalLink className="w-3 h-3" />
                  </a>
                </div>

                <div className="pt-4 border-t border-white/10 flex items-center gap-3">
                  <button className="flex-1 py-2.5 rounded-xl bg-emerald-500 text-white font-semibold text-xs hover:bg-emerald-600 transition-colors shadow-sm">
                    Approve Deliverable
                  </button>
                  <button className="py-2.5 px-4 rounded-xl bg-white/5 text-slate-300 font-medium text-xs hover:bg-white/10 transition-colors border border-white/10">
                    Request Changes
                  </button>
                </div>
              </div>
