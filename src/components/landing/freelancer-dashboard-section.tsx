...
export function FreelancerDashboardSection({ signupHref }: Props) {
  ...
  return (
    <section
      ...
      className="py-24 lg:py-32 px-5 sm:px-8 bg-[#FAFAFC] dark:bg-[#090A0F] text-slate-900 dark:text-white border-t border-slate-200/80 dark:border-white/[0.08] relative overflow-hidden transition-colors duration-300"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div ref={leftColRef} className="lg:col-span-5 space-y-6 sm:space-y-8">
            ...
            <h2 className="text-3xl sm:text-5xl font-normal tracking-[-0.03em] text-slate-950 dark:text-white leading-[1.08]">
              ...
              <span className="font-semibold text-slate-800 dark:text-slate-200">in one place</span>
            </h2>
            ...
            <div className="pt-2">
              <Link
                href={signupHref}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-slate-300 dark:border-white/20 hover:border-slate-400 dark:hover:border-white/40 bg-white dark:bg-white/[0.04] hover:bg-slate-50 dark:hover:bg-white/[0.08] text-slate-900 dark:text-white font-medium text-sm transition-all hover:scale-105 active:scale-95 shadow-xs group"
              >
                <span>View demo</span>
                <ExternalLink className="w-4 h-4 text-slate-500 dark:text-slate-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <div
              ref={dashboardRef}
              className="rounded-3xl bg-[#0e1017] border border-slate-200/90 dark:border-white/10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] dark:shadow-2xl p-5 sm:p-7 space-y-6 hover:border-slate-300 dark:hover:border-white/20 transition-colors text-white"
            >
