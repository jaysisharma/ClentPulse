...
export function SolutionSection({ signupHref }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-0 w-[500px] h-[350px] bg-emerald-500/[0.03] rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6">
            <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-6 rounded-2xl bg-[#0e1017] border border-white/10 hover:border-emerald-500/30 hover:bg-[#12141d] hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
