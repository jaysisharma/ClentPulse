...
export function SolutionSection({ signupHref }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-0 w-[500px] h-[350px] bg-emerald-500/[0.02] dark:bg-emerald-500/[0.04] rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div ref={leftColRef} className="lg:col-span-6 space-y-6 sm:space-y-8">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-normal tracking-[-0.03em] text-slate-950 dark:text-white leading-[1.08]">
              One link. <br />
              <span className="font-semibold text-slate-900 dark:text-slate-200">Everything your client needs.</span>
            </h2>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                href={signupHref}
                className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-full bg-slate-950 hover:bg-slate-800 text-white dark:bg-white dark:hover:bg-slate-100 dark:text-slate-950 font-medium text-sm transition-all shadow-md hover:shadow-xl active:scale-[0.98] group"
              >
          ...
          <div className="lg:col-span-6">
            <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-6 rounded-2xl bg-[#F9FAFC] dark:bg-[#0e1017] border border-slate-200/80 dark:border-white/10 hover:border-emerald-300 dark:hover:border-emerald-500/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200/60 dark:border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-4 group-hover:scale-110 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-500/20 transition-all">
