...
export function TestimonialsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[500px] h-[350px] bg-rose-500/[0.015] dark:bg-rose-500/[0.03] rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <div ref={headerRef} className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-normal tracking-[-0.03em] text-slate-950 dark:text-white leading-[1.08]">
            ...
            <span className="font-semibold text-slate-900 dark:text-slate-200">by freelancers</span>
          </h2>
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="p-7 rounded-3xl bg-[#FAFAFC] dark:bg-[#0e1017] border border-slate-200/80 dark:border-white/10 shadow-sm dark:shadow-2xl flex flex-col justify-between space-y-6 hover:shadow-xl dark:hover:border-white/20 hover:-translate-y-1.5 transition-all duration-300 relative group"
            >
              {/* Star Rating */}
              ...
              {/* Author */}
              <div className="flex items-center gap-3 pt-4 border-t border-slate-200/60 dark:border-white/[0.08]">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white text-sm group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{t.name}</div>
