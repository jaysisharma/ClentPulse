          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-200/60 dark:border-white/[0.08]">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs ${t.badgeColor} group-hover:scale-110 transition-transform shadow-xs`}>
                  {t.initials}
                </div>
                <div>
                  ...
                  <div className="text-xs text-slate-400 dark:text-slate-400 font-light">{t.role}</div>
                </div>
              </div>
            </div>
          ))}
