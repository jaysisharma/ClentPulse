      ...
      <div className="max-w-6xl mx-auto space-y-16 lg:space-y-20 relative z-10">
        ...
        <div ref={headerRef} className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-normal tracking-[-0.03em] text-white leading-[1.08]">
            ...
            <span className="font-semibold text-slate-200">for both sides</span>
          </h2>
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch relative">
          ...
          {/* ────────────────────────────────────────────── */}
          <div className="bg-[#0e1017] rounded-[28px] border border-white/10 shadow-2xl hover:border-white/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden group">
            
            {/* Step Meta Header */}
            <div className="p-7 pb-5 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-white text-slate-950 font-mono text-xs font-semibold group-hover:bg-indigo-400 transition-colors">
                  1
                </span>
            ...
            <div className="p-5 pt-0">
              <div className="rounded-2xl border border-white/[0.08] bg-[#131622] p-4 space-y-3.5 shadow-inner">
                ...
                <div className="flex items-center gap-1.5 pb-1 border-b border-white/[0.06]">
                  ...
                  <span className="text-[10px] font-mono text-slate-500 ml-2 truncate">portal.frevio.cloud</span>
                </div>

                {/* URL Bar with Copy Button */}
                <div className="flex items-center justify-between bg-[#0e1017] px-3 py-2.5 rounded-xl border border-white/10 shadow-sm text-xs">
                  ...
                  <button
                    type="button"
                    onClick={handleCopy}
                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-[10px] font-medium text-slate-300 hover:text-white bg-white/10 hover:bg-white/15 transition-all flex-shrink-0 active:scale-95"
                  >
                    {copied ? (
                      <>
                ...
                <div className="flex items-center justify-between px-1 text-[11px]">
                  <div className="flex items-center gap-1.5 text-slate-400 font-mono text-[10px]">
                    ...
                    <span>Passcode: <strong className="text-white font-mono">4892</strong></span>
                  </div>
                ...
                {/* Recipient status */}
                <div className="pt-1 border-t border-white/[0.06] flex items-center justify-between text-[10px] text-slate-400">
                  <span>Client access</span>
                  <span className="text-slate-300 font-medium">No account required</span>
                </div>
          ...
          <div className="bg-[#0e1017] rounded-[28px] border border-white/10 shadow-2xl hover:border-white/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden group">
            ...
            <div className="p-7 pb-5 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-white text-slate-950 font-mono text-xs font-semibold group-hover:bg-emerald-400 transition-colors">
                  2
                </span>
            ...
            <div className="p-5 pt-0">
              <div className="rounded-2xl border border-white/[0.08] bg-[#131622] p-4 space-y-3.5 shadow-inner">
                ...
                <div className="bg-[#0e1017] p-3 rounded-xl border border-white/10 shadow-sm space-y-2 text-xs">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-[11px] text-slate-300 leading-snug pl-1">
                ...
                <div className="space-y-1 pt-0.5">
                  <div className="flex items-center justify-between text-[10px] font-mono text-slate-400">
                    ...
                    <span className="font-semibold text-slate-200">75% Complete</span>
                  </div>
          ...
          <div className="bg-[#0e1017] rounded-[28px] border border-white/10 shadow-2xl hover:border-white/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden group">
            ...
            <div className="p-7 pb-5 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-white text-slate-950 font-mono text-xs font-semibold group-hover:bg-[#635BFF] transition-colors">
                  3
                </span>
            ...
            <div className="p-5 pt-0">
              <div className="rounded-2xl border border-white/[0.08] bg-[#131622] p-4 space-y-3.5 shadow-inner">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[10px] font-mono font-semibold text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded-full border border-indigo-500/20">
                    Milestone 2
                  </span>
                </div>

                {/* Amount Due Card */}
                <div className="bg-[#0e1017] p-3 rounded-xl border border-white/10 shadow-sm flex items-center justify-between">
                  <div>
                    <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400">Total Due</div>
                    <div className="text-lg font-bold text-white tracking-tight">$3,200.00</div>
                  </div>
