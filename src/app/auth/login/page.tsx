...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (initialMode === 'signup' || initialMode === 'login' || initialMode === 'forgot') {
  ...
  const subtitle =
    mode === 'forgot'
      ...
      : mode === 'login'
      ? 'Enter your credentials to access your studio workspace and client portals.'
    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#08090a] font-sans selection:bg-slate-200 dark:selection:bg-white/20">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 xl:p-16 bg-[#08090a] border-r border-white/10 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-lg space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/[0.03] shadow-xs">
          ...
          <h1 className="text-4xl xl:text-5xl font-light uppercase tracking-[-0.03em] leading-[1.15] text-white">
            Run Every Client Deliverable From One Obsidian Hub.
          </h1>

          <p className="text-sm leading-relaxed text-slate-400">
            Publish client briefings, legal contracts, and Stripe invoices with zero friction. Automatic tracking flags exactly what requires studio attention.
          </p>
        </div>

        {/* footer */}
        <div className="relative flex items-center justify-between text-xs text-slate-500">
          <span>Enterprise Studio Architecture</span>
            ...
            {codeSent ? (
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <h1 className="text-2xl sm:text-3xl font-light uppercase tracking-[-0.02em] text-slate-900 dark:text-white">
                    {title}
                  </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {mode === 'signup' && (
                    <div className="space-y-1.5">
                      <label htmlFor="fullName" className="block text-[11px] font-medium uppercase tracking-wider text-slate-600 dark:text-slate-400">
                        Full Name
                      </label>
                      <input
                        id="fullName"
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="email" className="block text-[11px] font-medium uppercase tracking-wider text-slate-600 dark:text-slate-400">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {mode === 'login' && (
                          <button
                            ...
                            className="text-[11px] font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 cursor-pointer transition-colors"
                          >
                            Forgot password?
                          </button>
                        )}
                  ...
                  <>
                    <div className="relative my-2">
                      ...
                      <div className="relative flex justify-center text-[10px] font-semibold uppercase tracking-wider">
                        <span className="bg-white dark:bg-[#0c0d12] px-3 text-slate-400 dark:text-slate-500">or</span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      type="button"
                      className="flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-full border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 py-2.5 text-xs font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-200 transition-all hover:bg-slate-100 dark:hover:bg-white/10 shadow-xs"
                    >
                ...
                <div className="text-center text-xs text-slate-500 dark:text-slate-400 pt-1">
                  {mode === 'forgot' ? (
                    <button
                      type="button"
                      onClick={() => switchMode('login')}
                      className="cursor-pointer font-semibold text-slate-900 dark:text-white hover:underline"
                    >
                      ← Back to Sign In
                    </button>
                  ) : mode === 'login' ? (
                    <>
                      ...
                      <button type="button" onClick={() => switchMode('signup')} className="cursor-pointer font-semibold text-slate-900 dark:text-white hover:underline">
                        Sign up
                      </button>
                    </>
                  ) : (
                    <>
                      ...
                      <button type="button" onClick={() => switchMode('login')} className="cursor-pointer font-semibold text-slate-900 dark:text-white hover:underline">
                        Sign in
                      </button>
                    </>
                  )}
