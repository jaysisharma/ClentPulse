            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {bullets.map((bullet, i) => (
                  <div key={i} className="flex gap-3 items-center bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 p-3 rounded-xl focus-within:bg-white dark:focus-within:bg-slate-800  focus-within:border-indigo-200 transition-all">
                    <span 
