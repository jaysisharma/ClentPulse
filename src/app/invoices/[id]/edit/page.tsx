  ...
  return (
    <AppLayout>
      <div className="max-w-2xl animate-fade-in">
        <Link href={`/invoices/${id}`} className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 mb-6 transition-colors">
          <ArrowLeft className="w-4 h-4" />Back to invoice
        </Link>
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Edit invoice</h1>
        <p className="text-slate-500 text-sm mb-8">Changes are saved immediately. Status is not affected.</p>
